class DropBoxController {
  ...
  constructor(){
   ...
   // Evento de click e sua ultilização no botão 'Enviar Arquivos'
   ...
   // Quando o upload é terminado o modalShow fecha a aba de upload 
   ...
   // Recebe os arquivos para a realização do upload
   ...
   // Progresso de upload de arquivos e tempo restante 
   ...
   // Duração do upload de envio dos arquivos 
   ...
   // Tipo de ícone a ser tratado

   getFileIconView(file){

     switch(file.type){

   // ELEMENT 'Meus Documentos'
   ...
   // Tipo do do arquivo a ser tratado 
